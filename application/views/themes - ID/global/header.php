...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cherry+Bomb+One&family=Hedvig+Letters+Sans&family=League+Spartan:wght@100..900&family=Luckiest+Guy&family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap" rel="stylesheet">
            ...
            <div class="container">
                <a class="navbar-brand brand-logo " href="<?php echo base_url(); ?>">
                    <div class="logo-wrapper">
                         <img  src="<?php echo base_url(); ?>public/belfoods.png"  alt="<?php echo $belfoodsLogoAltText; ?>" width="100%" >
                    </div>
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    ...
                    aria-label="<?php echo $toggleNavigationLabel; ?>">
